...
EvtScript N(EVS_ManageFirstPhase) = {
    ...
    Switch(LVar0)
        ...
        CaseEq(AVAL_GreenPhase)
            ...
            // Bowser Phase Actors
            Call(SetActorPos, ACTOR_KOOPA_THE_KID, NPC_DISPOSE_LOCATION)
            Call(ForceHomePos, ACTOR_KOOPA_THE_KID, NPC_DISPOSE_LOCATION)
            Call(SetActorFlagBits, ACTOR_KOOPA_THE_KID, ACTOR_FLAG_NO_ATTACK | ACTOR_FLAG_SKIP_TURN | ACTOR_FLAG_NO_HEALTH_BAR, TRUE)
            Call(SetPartFlagBits, ACTOR_KOOPA_THE_KID, PRT_MAIN, ACTOR_PART_FLAG_NO_TARGET | ACTOR_PART_FLAG_INVISIBLE, TRUE)
            // Call(RemoveActor, ACTOR_KOOPA_THE_KID)
        ...
        CaseEq(AVAL_RedPhase)
            // Green Phase Actors
            Call(EnableModel, MODEL_jam_bt00_BombBox, TRUE)
            Call(EnableModel, MODEL_jam_bt00_BombPile, TRUE)
            Call(EnableModel, MODEL_jam_bt00_BarrelRed, TRUE)
        ...
        CaseEq(AVAL_BowserPhase)
            ...
            // Bowser Phase Actors
            Call(SetActorPos, ACTOR_KOOPA_THE_KID, 100, 35, 20)
            Call(ForceHomePos, ACTOR_KOOPA_THE_KID, 100, 35, 20)
    ...
    Label(0)
        ...
        Loop(0)
            ...
            IfGt(LVar0, 1000)
                ...
                Call(SetPartFlagBits, ACTOR_HAMMER_BRO_ALT, PRT_MAIN, ACTOR_PART_FLAG_NO_TARGET | ACTOR_PART_FLAG_INVISIBLE, FALSE)
            EndIf
            IfGt(LVar0, 2250)

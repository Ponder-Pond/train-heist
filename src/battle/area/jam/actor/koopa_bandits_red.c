...
enum N(ThisBanditsParams) {
    ...
    THIS_ANIM_IDLE              = ANIM_KoopaGang_Red_Idle,
    THIS_ANIM_STILL             = ANIM_KoopaGang_Red_Still,
    THIS_ANIM_SLEEP             = ANIM_KoopaGang_Red_Sleep,
    THIS_ANIM_DIZZY             = ANIM_KoopaGang_Red_Dizzy,
    ...
    THIS_ANIM_BURN              = ANIM_KoopaGang_Red_BurnHurt,
    THIS_ANIM_BURN_STILL        = ANIM_KoopaGang_Red_BurnStill,
    THIS_ANIM_TOWER_IDLE        = ANIM_KoopaGang_Red_IdleCrouch,
    THIS_ANIM_TOWER_STILL       = ANIM_KoopaGang_Red_StillCrouch,
    THIS_ANIM_TOPPLE_IDLE       = ANIM_KoopaGang_Red_IdleToppled,
    THIS_ANIM_TOPPLE_STILL      = ANIM_KoopaGang_Red_StillToppled,
    THIS_ANIM_TOPPLE_DIZZY      = ANIM_KoopaGang_Red_DizzyToppled,
    THIS_ANIM_TIPPING_IDLE      = ANIM_KoopaGang_Red_IdleTipping,

...
BattleList A(Formations) = {
    BATTLE(A(Formation_00), A(trn_00), "The Train Heist Phase 1"),
    BATTLE(A(Formation_01), A(trn_00), "The Train Heist Phase 2"),
    BATTLE(A(Formation_02), A(trn_00), "The Train Heist Phase 3"),
    BATTLE(A(Formation_03), A(trn_00), "The Train Heist Phase 4"),
    BATTLE(A(Formation_04), A(trn_00), "The Train Heist Final Phase"),
    {},
};
